...
public class Database{
  ...
  public void insertData(String userid,String userpass,String name,String birthday,String memo){
    try{
      String sql="insert into userdata (userid,userpass,username,birthday,memo) values ('"+userid+"','"+userpass+"','"+name+"','"+birthday+"','"+memo+"')";
  ...
  public void editData(String userid,String userpass,String name,String birthday,String memo){
    try{
      String sql="update userdata set userpass= '"+userpass+"',username= '"+name+"',birthday= '"+birthday+"' ,memo= '"+memo+"'where userid='"+userid+"'";
...
public void deleteData(String id){
  try{
    String sql="delete from userdata where userid ='"+id+"';";
    int a=stmt.executeUpdate(sql);
  }catch(Exception ex){
    System.out.println(ex);
  }
